...
public class MyapphipApp {

    private static final Logger log = LoggerFactory.getLogger(MyapphipApp.class);

    private final Environment env;

    public MyapphipApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes myapphip.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MyapphipApp.class);
